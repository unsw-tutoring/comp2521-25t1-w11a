...
int ListCountOdd(struct node *l) {
    ...
    int numberOfOddNodesInRestOfList = ListCountOdd(l->next);

    // if (l->data % 2 == 1) {
    //     return 1 + numberOfOddNodesInRestOfList;
    // } else {
    //     return numberOfOddNodesInRestOfList;
    // }
    return (l->data % 2) + numberOfOddNodesInRestOfList;
}
...
bool ListIsSorted(struct node *l) {
    ...
    // what does the recursive call do?
